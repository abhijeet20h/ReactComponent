...
<div className="col-md-4"> <div className="img_custum">  <img  src="https://img.pngio.com/react-logo-png-download-500500-free-transparent-react-png-react-png-900_500.jpg" alt="mypic" className="card_img" /> </div></div>
